...
<!--
Active entries shape:
- **Q<N>** — <question> (raised: YYYY-MM-DD, blocks: <what>)

Resolved entries — one of four forms:
- **Q1** — ✅ Resolved → see DECISIONS.md #4
- **Q2** — ✅ Resolved → see exploration/apis/API-EXPLORATION.md §3.2 Review comment #5
